...
function nextDay() {
  var dayIn = document.getElementById('date_data').valueAsNumber;
  var monthIn = document.getElementById('month_data').valueAsNumber;
  var yearIn = document.getElementById('year_data').valueAsNumber;
  var dayOut = dayIn + 1,
      monthOut = monthIn,
      yearOut = yearIn;
  ...
  function showResult() {
    var result = '';
    result = "".concat(dayOut, ".").concat(monthOut, ".").concat(yearOut);
